...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<SampleWebViewViewModel>();
            services.AddTransient<SampleWebViewPage>();
            ...
            services.AddDbContext<WinUIContext>(options =>
              options.UseSqlServer(context.Configuration.GetConnectionString("WinUIContext")));
        }).
        Build();
