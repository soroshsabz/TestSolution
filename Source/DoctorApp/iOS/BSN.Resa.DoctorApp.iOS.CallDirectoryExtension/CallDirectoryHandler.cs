...
namespace BSN.Resa.DoctorApp.iOS.CallDirectoryExtension
{
	...
	public class CallDirectoryHandler : CXCallDirectoryProvider, ICXCallDirectoryExtensionContextDelegate
	{
		...
		bool AddBlockingPhoneNumbers(CXCallDirectoryExtensionContext context)
		{
			...
			long[] phoneNumbers = BlockedPhoneNumbers.Instance.GetAllSorted().ToArray();
		...
		bool AddIdentificationPhoneNumbers(CXCallDirectoryExtensionContext context)
		{
			...
			//long[] phoneNumbers = { 982188220634 };
			//string[] labels = { "Telemarketer" };
